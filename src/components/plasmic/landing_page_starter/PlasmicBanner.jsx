...
import * as sty from "./PlasmicBanner.module.css"; // plasmic-import: UrEbICrkwEs8Y2/css
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <img
              alt={""}
              className={classNames(defaultcss.img, sty.img__jzFa2)}
              role={"img"}
              src={
