...
import * as sty from "./PlasmicButton.module.css"; // plasmic-import: 0GJhn4Yg6J5JLp/css
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: O0MkAVvJP7OBsv/icon
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(defaultcss.all, sty.svg__xoTEk)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(defaultcss.all, sty.svg__eD8H5)}
                role={"img"}
              />
            ),
