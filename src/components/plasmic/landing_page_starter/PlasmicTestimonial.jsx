...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: qHxTQmSUkQakhY/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__ihJqH)}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__oe6P)}
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <img
              alt={""}
              className={classNames(defaultcss.img, sty.img__fVwly)}
              role={"img"}
            />
          ),
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__ogGpX)}
        >
          <div className={classNames(defaultcss.all, sty.freeBox__csHHh)}>
            {p.renderPlasmicSlot({
