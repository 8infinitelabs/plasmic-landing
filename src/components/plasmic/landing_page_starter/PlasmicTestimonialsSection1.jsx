...
import * as sty from "./PlasmicTestimonialsSection1.module.css"; // plasmic-import: mhVu1OTRY_osrv/css
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Testimonial
                className={classNames("__wab_instance", sty.testimonial__rvbBh)}
                slot={
                  <img
                    alt={""}
                    className={classNames(defaultcss.img, sty.img__tMYmn)}
                    role={"img"}
                    src={
              ...
              <Testimonial
                className={classNames("__wab_instance", sty.testimonial__zput)}
                slot={
                  <img
                    alt={""}
                    className={classNames(defaultcss.img, sty.img__krzxk)}
                    role={"img"}
                    src={
              ...
              <Testimonial
                className={classNames(
                  "__wab_instance",
                  sty.testimonial___6EkJe
                )}
                slot={
                  <img
                    alt={""}
                    className={classNames(defaultcss.img, sty.img__d8Dc)}
                    role={"img"}
                    src={
              ...
              <Testimonial
                className={classNames("__wab_instance", sty.testimonial__cjYdj)}
                slot={
                  <img
                    alt={""}
                    className={classNames(defaultcss.img, sty.img__fjtoP)}
                    role={"img"}
                    src={
