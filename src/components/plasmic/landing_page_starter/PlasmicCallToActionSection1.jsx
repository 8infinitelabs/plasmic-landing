...
import * as sty from "./PlasmicCallToActionSection1.module.css"; // plasmic-import: ljzVk4zBuS7BLT/css
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <React.Fragment>
                <img
                  alt={""}
                  className={classNames(defaultcss.img, sty.img__qRpdi)}
                  role={"img"}
                  src={
                ...
                <div
                  className={classNames(defaultcss.all, sty.freeBox__xKi3F)}
                />
              </React.Fragment>
            ),
            ...
            defaultContents: (
              <React.Fragment>
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(defaultcss.all, sty.freeBox___6FXy)}
                >
                  <div
                ...
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(defaultcss.all, sty.freeBox__bf5Jv)}
                >
                  <Button
                    className={classNames("__wab_instance", sty.button__s0WVi)}
                    colors={"blue"}
                    slot={"Start now ->"}
                  />
                  ...
                  <Button
                    ...
                    className={classNames("__wab_instance", sty.button__ywfNz)}
                    darkGray={"darkGray"}
                    slot={
                      <div
                        className={classNames(
